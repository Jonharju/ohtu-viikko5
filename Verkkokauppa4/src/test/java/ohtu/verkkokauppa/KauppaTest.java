...
public class KauppaTest {
    ...
    @Test
    public void ostoksenPaaytyttyaEdellisenOstoksenTiedotNollataan() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.lisaaKoriin(1);
        k.tilimaksu("janne", "12346");

        // sitten suoritetaan varmistus, että pankin metodia tilisiirto on kutsuttu
        verify(pankki).tilisiirto(eq("janne"), eq(42), eq("12346"), eq("33333-44455"),eq(10));
    }
    
    @Test
    public void kaytetaanUuttaViitenumeroaJoka() {
        Pankki pankki = mock(Pankki.class);
        ...
        // sitten suoritetaan varmistus, että pankin metodia tilisiirto on kutsuttu
        verify(pankki).tilisiirto(eq("janne"), eq(43), eq("12346"), eq("33333-44455"),eq(10));
        verify(viite, times(2)).uusi();
    }
    
    @Test
    public void ostoksenPoistaminenToimiiOikein() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
